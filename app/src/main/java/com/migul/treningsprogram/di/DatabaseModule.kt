...
import com.migul.treningsprogram.data.db.dao.ExerciseFeedbackDao
...
object DatabaseModule {
    ...
    @Provides fun provideExerciseFeedbackDao(db: AppDatabase): ExerciseFeedbackDao = db.exerciseFeedbackDao()
}
